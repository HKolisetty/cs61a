...
def funception(func1, start):
    ...
    def func2(stop):
        ...
        elif start>=stop: return func1(start)
        else:
            result = 1
...
def mod_maker():
    """Return a two-argument function that performs the modulo operation and returns True if the numbers are divisible, and the remainder otherwise.
