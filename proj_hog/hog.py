...
def tail_points(opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    return 2 * abs((opponent_score%100//10)-(opponent_score%10)) + 1
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    best_roll = 0
    while i <=10:
        test_roll = make_averaged(roll_dice,total_samples)(i,dice)
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    tail_result = tail_points(opponent_score)
    if tail_result >= threshold:
        return 0
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    square_result = square_update(0,score,opponent_score)
    if square_result-score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
